package com.bank.bian.currencyexchange.model;
...
/**
 * The BIAN control record for this service domain: "FX Deal Procedure".
 *
 ...
 * to its asset type (FX Deal). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "FX Deal Procedure";
